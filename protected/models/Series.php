...
class Series extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('season, episode, status', 'numerical', 'integerOnly'=>true),
			array('title', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, season, episode, status, wikiLink, torrentLink, image', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('torrentLink',$this->torrentLink);
